...
DEBATES = [
    {
        ...
        "components": [
            ...
            ("Deneyde öğretmen geri bildirimiyle kullanılan yapay zeka araçları öğrencilerin kavram yanılgılarını azaltmıştır.", "evidence"),
            ("Denetimsiz kullanımda öğrencilerin aracı kopyalama için kullandığı raporlandı.", "evidence"),
            ...
            ("Deneyde öğretmen geri bildirimi olmadan kullanılan araçların öğrenme kazanımını artırmadığı görüldü.", "evidence"),
            ("Öğrencilerin problem çözme becerileri gelişti.", "claim"),
            ("Michigan Üniversitesi çalışması, öğrencilerin bağımsız problem çözme becerilerinin gerilediğini gösterdi.", "evidence"),
    ...
    },
    {
        ...
        "components": [
            ...
            ("Resmi bültende 2024 yıl sonu enflasyonunun yüzde 20 olduğu yazıyor.", "evidence"),
            ("Türkiye ekonomisi 2024 yılında yüzde 10 büyüdü.", "claim"),
            ("Türkiye ekonomisi 2004 yılında yüksek büyüme oranı yakalamıştı.", "evidence"),
            ("Bakan enflasyonun yıl sonunda tek haneye düşeceğini söyledi.", "claim"),
            ("Bakan konuşmasında yıl sonu için tek haneli enflasyon hedefi vermediğini açıkça belirtti.", "evidence"),
            ("Konut fiyatları reel olarak yükseldi.", "claim"),
            ("Raporda nominal fiyatların arttığı, ancak enflasyondan arındırılmış reel fiyatların düştüğü belirtildi.", "evidence"),
            ...
            ("TÜİK tablosu genç işsizlik oranının 2024'te önceki yıla göre düştüğünü gösterdi.", "evidence"),
        ],
        "relations": [
            (
